...
class ParticularInquiryActivityLog : BaseActivity(), View.OnClickListener, RecyclerClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_particular_inquiry_log)
    ...
    override fun initializeView() {
        if (isOnline(this@ParticularInquiryActivityLog)) {
            callActivityLog()
        } else {
            internetErrordialog(this@ParticularInquiryActivityLog)
        }
        SetInitListner()
    }
    ...
    private fun SetInitListner() {
        ...
        adapter = ParticularInquiryAdapter(arrayListActivity!!, this@ParticularInquiryActivityLog, tabPosition)
        ...
        searchView.setOnQueryTextListener(object : SimpleSearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String): Boolean {
                ...
                if (newText.trim().isNotEmpty()) {
                    ...
                    val itemAdapter = ParticularInquiryAdapter(arrayListActivity!!, this@ParticularInquiryActivityLog, tabPosition)
        ...
        searchView.setOnSearchViewListener(object : SimpleSearchView.SearchViewListener {
            ...
            override fun onSearchViewClosedAnimation() {
                AnimationUtils.loadAnimation(
                    this@ParticularInquiryActivityLog,
        ...
        refreshLayout.setOnRefreshListener {
            hideKeyboard(this@ParticularInquiryActivityLog, refreshLayout)
            searchView.closeSearch()
            callActivityLog()
    ...
    override fun onClick(v: View?) {
        hideKeyboard(this@ParticularInquiryActivityLog, v)
        when (v?.id) {
            R.id.imgBack -> {
                preventTwoClick(v)
                finish()
