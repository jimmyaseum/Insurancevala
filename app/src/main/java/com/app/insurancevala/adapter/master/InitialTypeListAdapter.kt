...
class InitialTypeListAdapter(private val context: Context?, private val arrayList: ArrayList<InitialModel>, private val recyclerItemClickListener: RecyclerClickListener) : RecyclerView.Adapter<InitialTypeListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            context: Context,
            position: Int,
            arrayList : ArrayList<InitialModel>,
            recyclerItemClickListener: RecyclerClickListener
        ) {
            this.context = context


            if(!arrayList[position].Initial.isNullOrEmpty()) {
                itemView.txtType.text = arrayList[position].Initial
            }
