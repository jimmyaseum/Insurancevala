...
class BottomSheetCategoryListAdapter(val context: Context?, private val arrayList : ArrayList<CategoryModel>) : RecyclerView.Adapter<BottomSheetCategoryListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            itemView.txtName.text = arrayList.CategoryName
