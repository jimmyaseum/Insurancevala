...
import com.app.insurancevala.model.response.CallResultModel
import kotlinx.android.synthetic.main.row_select.view.*

class BottomSheetCallResultListAdapter(val context: Context?, private val arrayList : ArrayList<CallResultModel>) : RecyclerView.Adapter<BottomSheetCallResultListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            arrayList : CallResultModel
        ) {
            this.context = context


            itemView.txtName.text = arrayList.CallResult
