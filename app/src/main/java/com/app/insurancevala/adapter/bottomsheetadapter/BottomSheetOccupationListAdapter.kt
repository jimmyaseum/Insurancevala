...
class BottomSheetOccupationListAdapter(val context: Context?, private val arrayList : ArrayList<OccupationModel>) : RecyclerView.Adapter<BottomSheetOccupationListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            arrayList : OccupationModel
        ) {
            this.context = context


            itemView.txtName.text = arrayList.OccupationName
