...
class BottomSheetListAdapter(val context: Context?, private val arrayList : ArrayList<SingleSelectionModel>) : RecyclerView.Adapter<BottomSheetListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            arrayList : SingleSelectionModel
        ) {
            this.context = context


            itemView.txtName.text = arrayList.Name
