...
class OccupationTypeListAdapter(private val context: Context?, private val arrayList: ArrayList<OccupationTypeModel>, private val recyclerItemClickListener: RecyclerClickListener) : RecyclerView.Adapter<OccupationTypeListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            context: Context,
            position: Int,
            arrayList : ArrayList<OccupationTypeModel>,
            recyclerItemClickListener: RecyclerClickListener
        ) {
            this.context = context


            if(!arrayList[position].OccupationName.isNullOrEmpty()) {
                itemView.txtType.text = arrayList[position].OccupationName
            }
