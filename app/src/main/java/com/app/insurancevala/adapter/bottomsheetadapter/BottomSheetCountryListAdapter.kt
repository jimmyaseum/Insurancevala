...
class BottomSheetCountryListAdapter(val context: Context?, private val arrayList : ArrayList<CountryModel>) : RecyclerView.Adapter<BottomSheetCountryListAdapter.ViewHolder>() {
