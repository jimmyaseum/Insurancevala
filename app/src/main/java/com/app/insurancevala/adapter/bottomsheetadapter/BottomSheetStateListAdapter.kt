...
class BottomSheetStateListAdapter(val context: Context?, private val arrayList : ArrayList<StateModel>) : RecyclerView.Adapter<BottomSheetStateListAdapter.ViewHolder>() {
