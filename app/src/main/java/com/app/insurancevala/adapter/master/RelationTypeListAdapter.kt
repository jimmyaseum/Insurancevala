...
class RelationTypeListAdapter(private val context: Context?, private val arrayList: ArrayList<RelationTypeModel>, private val recyclerItemClickListener: RecyclerClickListener) : RecyclerView.Adapter<RelationTypeListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            context: Context,
            position: Int,
            arrayList : ArrayList<RelationTypeModel>,
            recyclerItemClickListener: RecyclerClickListener
        ) {
            this.context = context


            if(!arrayList[position].RelationName.isNullOrEmpty()) {
                itemView.txtType.text = arrayList[position].RelationName
            }
