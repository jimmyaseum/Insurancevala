...
import com.app.insurancevala.model.response.MeetingTypeModel
import com.app.insurancevala.utils.gone
import com.app.insurancevala.utils.visible
import kotlinx.android.synthetic.main.row_select.view.*

class BottomSheetMeetingTypeListAdapter(val context: Context?, private val arrayList : ArrayList<MeetingTypeModel>) : RecyclerView.Adapter<BottomSheetMeetingTypeListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            arrayList : MeetingTypeModel
        ) {
            this.context = context


            itemView.txtName.text = arrayList.MeetingType
