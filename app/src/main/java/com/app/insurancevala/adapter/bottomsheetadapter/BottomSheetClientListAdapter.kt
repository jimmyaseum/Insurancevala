...
class BottomSheetClientListAdapter(val context: Context?, private val arrayList : ArrayList<LeadModel>) : RecyclerView.Adapter<BottomSheetClientListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            itemView.txtName.text = arrayList.FirstName + " " + arrayList.LastName

            itemView.txtCustomerCode.visible()
            itemView.txtCustomerCode.text = arrayList.GroupCode
