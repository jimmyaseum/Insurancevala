...
class BottomSheetPlanListAdapter(val context: Context?, private val arrayList : ArrayList<PlanModel>) : RecyclerView.Adapter<BottomSheetPlanListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            itemView.txtName.text = arrayList.PlanName
