...
class BottomSheetUsersListAdapter(val context: Context?, private val arrayList : ArrayList<UserModel>) : RecyclerView.Adapter<BottomSheetUsersListAdapter.ViewHolder>() {
