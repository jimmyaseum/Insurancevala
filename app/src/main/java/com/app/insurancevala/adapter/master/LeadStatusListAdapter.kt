...
class LeadStatusListAdapter(private val context: Context?, private val arrayList: ArrayList<LeadStatusModel>, private val recyclerItemClickListener: RecyclerClickListener) : RecyclerView.Adapter<LeadStatusListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            context: Context,
            position: Int,
            arrayList : ArrayList<LeadStatusModel>,
            ...
            if(!arrayList[position].LeadStatus.isNullOrEmpty()) {
                itemView.txtType.text = arrayList[position].LeadStatus
            }
