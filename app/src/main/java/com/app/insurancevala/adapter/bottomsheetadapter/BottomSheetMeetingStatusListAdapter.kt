...
class BottomSheetMeetingStatusListAdapter(val context: Context?, private val arrayList : ArrayList<MeetingStatusModel>) : RecyclerView.Adapter<BottomSheetMeetingStatusListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            arrayList : MeetingStatusModel
        ) {
            this.context = context


            itemView.txtName.text = arrayList.MeetingStatus
