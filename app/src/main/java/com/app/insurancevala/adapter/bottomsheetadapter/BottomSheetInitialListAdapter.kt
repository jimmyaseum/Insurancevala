...
class BottomSheetInitialListAdapter(val context: Context?, private val arrayList : ArrayList<InitialModel>) : RecyclerView.Adapter<BottomSheetInitialListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            arrayList : InitialModel
        ) {
            this.context = context


            itemView.txtName.text = arrayList.Initial
