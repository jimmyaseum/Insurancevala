...
class BottomSheetLeadTypeListAdapter(val context: Context?, private val arrayList : ArrayList<LeadTypeModel>) : RecyclerView.Adapter<BottomSheetLeadTypeListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            arrayList : LeadTypeModel
        ) {
            this.context = context


            itemView.txtName.text = arrayList.LeadType
