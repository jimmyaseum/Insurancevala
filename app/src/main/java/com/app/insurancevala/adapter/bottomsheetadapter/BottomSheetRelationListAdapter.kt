...
class BottomSheetRelationListAdapter(val context: Context?, private val arrayList : ArrayList<RelationModel>) : RecyclerView.Adapter<BottomSheetRelationListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            arrayList : RelationModel
        ) {
            this.context = context


            itemView.txtName.text = arrayList.RelationName
