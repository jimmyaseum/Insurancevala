...
class BottomSheetLeadStatusListAdapter(val context: Context?, private val arrayList : ArrayList<LeadStatusModel>) : RecyclerView.Adapter<BottomSheetLeadStatusListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            arrayList : LeadStatusModel
        ) {
            this.context = context


            itemView.txtName.text = arrayList.LeadStatus
