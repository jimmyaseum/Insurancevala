...
import com.app.insurancevala.model.response.MeetingOutcomeModel
import com.app.insurancevala.utils.gone
import com.app.insurancevala.utils.visible
import kotlinx.android.synthetic.main.row_select.view.*

class BottomSheetMeetingOutcomeListAdapter(val context: Context?, private val arrayList : ArrayList<MeetingOutcomeModel>) : RecyclerView.Adapter<BottomSheetMeetingOutcomeListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            arrayList : MeetingOutcomeModel
        ) {
            this.context = context


            itemView.txtName.text = arrayList.MeetingOutcome
