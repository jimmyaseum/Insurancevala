...
class BottomSheetLeadSourceListAdapter(val context: Context?, private val arrayList : ArrayList<LeadSourceModel>) : RecyclerView.Adapter<BottomSheetLeadSourceListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            arrayList : LeadSourceModel
        ) {
            this.context = context


            itemView.txtName.text = arrayList.LeadSource
