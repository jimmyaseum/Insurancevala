...
class BottomSheetCompanyListAdapter(val context: Context?, private val arrayList : ArrayList<CompanyModel>) : RecyclerView.Adapter<BottomSheetCompanyListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            itemView.txtName.text = arrayList.CompanyName
