...
class BottomSheetInquirySubTypeListAdapter(val context: Context?, private val arrayList : ArrayList<InquirySubTypeModel>) : RecyclerView.Adapter<BottomSheetInquirySubTypeListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            arrayList : InquirySubTypeModel
        ) {
            this.context = context

            itemView.txtName.text = arrayList.InquirySubType
