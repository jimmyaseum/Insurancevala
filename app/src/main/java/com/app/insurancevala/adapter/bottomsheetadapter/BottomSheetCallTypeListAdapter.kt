...
import com.app.insurancevala.model.response.CallTypeModel
import com.app.insurancevala.utils.gone
import com.app.insurancevala.utils.visible
import kotlinx.android.synthetic.main.row_select.view.*

class BottomSheetCallTypeListAdapter(val context: Context?, private val arrayList : ArrayList<CallTypeModel>) : RecyclerView.Adapter<BottomSheetCallTypeListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            arrayList : CallTypeModel
        ) {
            this.context = context


            itemView.txtName.text = arrayList.CallType
